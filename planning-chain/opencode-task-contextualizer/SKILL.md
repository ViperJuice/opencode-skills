...
This skill normally writes no reflection or handoff. If a future workflow adds self-improvement state, follow `runtime-state.md` and use OpenCode paths only:
